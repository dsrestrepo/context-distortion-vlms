#!/bin/bash
#SBATCH --job-name=open_models_5class
#SBATCH --output=logs/open_models_5class.out
...
# Run the open-model 5-class experiment
...
srun "${SRUN_GPU_ARGS[@]}" python -m scripts.run_5class --model-family open_models
