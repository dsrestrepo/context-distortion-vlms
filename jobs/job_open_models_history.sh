#!/bin/bash
#SBATCH --job-name=open_models_history
#SBATCH --output=logs/open_models_history.out
...
# Run the open-model history experiment
...
srun "${SRUN_GPU_ARGS[@]}" python -m scripts.run_history --model-family open_models
