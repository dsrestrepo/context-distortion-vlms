#!/bin/bash
#SBATCH --job-name=open_models_race
#SBATCH --output=logs/open_models_race.out
...
srun "${SRUN_GPU_ARGS[@]}" python -m scripts.run_mimic_targets --model-family open_models --experiments race
