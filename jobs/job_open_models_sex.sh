#!/bin/bash
#SBATCH --job-name=open_models_sex
#SBATCH --output=logs/open_models_sex.out
...
srun "${SRUN_GPU_ARGS[@]}" python -m scripts.run_mimic_targets --model-family open_models --experiments sex
