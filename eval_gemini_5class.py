...
N_SAMPLES = 500  # The desired number of samples for each category
...
generate_predictions_models(model_dict, metadata_test, return_logits=False, dataset="mimic_5class", store_columns=["dicom_id", "age", "sex", "race"], label="class_label", text_col="report", image_col="filepath", metadata_cols=["age", "sex", "race", "PerformedProcedureStepDescription", "ViewPosition"], unmatched=False, versions=versions, priority_img=priority_img)