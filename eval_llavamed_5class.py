...
#generate_predictions_models(model_dict, metadata_test, quantization="16b", return_attention=False, return_logits=True, dataset="mimic_5class_test", store_columns=["dicom_id", "age", "sex", "race"], label="class_label", text_col="report", image_col="filepath", metadata_cols=["age", "sex", "race", "PerformedProcedureStepDescription", "ViewPosition"], conv_mode=conv_mode, unmatched=True, versions=versions, tokens=['yes', 'no', 'Yes', 'No', 'None', 'none'])
generate_predictions_models(model_dict, metadata_test, quantization=None, use_flash_attention=True, return_attention=False, return_logits=True, dataset="mimic_5class", store_columns=["dicom_id", "age", "sex", "race"], label="class_label", text_col="report", image_col="filepath", metadata_cols=["age", "sex", "race", "PerformedProcedureStepDescription", "ViewPosition"], conv_mode=conv_mode, unmatched=False, versions=versions, priority_img=priority_img)
